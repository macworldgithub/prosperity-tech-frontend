    ...
    <section className="relative flex flex-col items-center justify-center text-center text-white overflow-hidden">
      ...
      <div className="-mt-24 md:-mt-36 z-10 flex flex-col items-center justify-center px-6 sm:mt-12">
        ...
        <button
          ...
          className="px-6 sm:px-10 md:px-20 py-3 bg-gradient-to-r from-[#1d5e8e] to-[#2d9558] text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
        >
          Chat with AI
        </button>
      </div>
